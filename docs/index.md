...
The provider supports two authentication methods. Environment variables take precedence when both are set.
...
2. Environment variables (`APPWRITE_ENDPOINT`, `APPWRITE_PROJECT_ID`, `APPWRITE_ORGANIZATION_ID`, `APPWRITE_API_KEY`)
