---
page_title: "Resource: appwrite_mongo_backup_storage"
subcategory: "Dedicated Databases"
description: |-
  Sends the backups of a dedicated Appwrite MongoDB database to a bucket you own rather than Appwrite's default storage.
...
# Resource: appwrite_mongo_backup_storage
...
- [appwrite_mongo_database](mongo_database.md) - Manage the database whose backups are redirected
- [appwrite_mongo_backup_policy](mongo_backup_policy.md) - Schedule the backups that land in this bucket
