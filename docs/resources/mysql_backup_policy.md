---
page_title: "Resource: appwrite_mysql_backup_policy"
subcategory: "Dedicated Databases"
description: |-
  Manages a scheduled backup policy for a dedicated Appwrite MySQL database. Use `appwrite_backup_policy` instead for databases running on Appwrite's shared infrastructure.
---

# Resource: appwrite_mysql_backup_policy
...
- [appwrite_mysql_database](mysql_database.md) - Manage the database this policy backs up
