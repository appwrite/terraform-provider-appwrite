---
page_title: "Resource: appwrite_postgresql_database"
subcategory: "Dedicated Databases"
description: |-
  Manages a dedicated Appwrite PostgreSQL database. A dedicated database runs on infrastructure reserved for one project, so creating, resizing or upgrading one takes several minutes; Terraform waits for the database to settle before continuing.
---

# Resource: appwrite_postgresql_database
...
- `version` (String) The PostgreSQL engine version. Changing this performs an in-place major version upgrade, which cannot be rolled back.
...
- [appwrite_postgresql_backup_policy](postgresql_backup_policy.md) - Schedule backups for the database
- [appwrite_postgresql_pooler](postgresql_pooler.md) - Configure the connection pooler
- [appwrite_postgresql_extension](postgresql_extension.md) - Install PostgreSQL extensions
